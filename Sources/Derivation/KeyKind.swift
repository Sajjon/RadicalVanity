...
extension KeyKind {
	public var description: String {
		switch self {
		case .transactionSigning: "transactionSigning"
		case .authenticationSigning: "authenticationSigning"
	...
	public var asciiSource: String {
		switch self {
		case .transactionSigning: "TRANSACTION_SIGNING"
		case .authenticationSigning: "AUTHENTICATION_SIGNING"
		case .messageEncryption: "MESSAGE_ENCRYPTION"
		}
	}
	#endif // DEBUG
}
